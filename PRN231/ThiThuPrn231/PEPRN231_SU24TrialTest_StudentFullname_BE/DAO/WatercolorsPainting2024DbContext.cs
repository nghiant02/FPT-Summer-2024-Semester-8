...
public partial class WatercolorsPainting2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.StyleId).HasName("PK__Style__8AD14640D03ED2A7");
        ...
        {
            entity.HasKey(e => e.UserAccountId).HasName("PK__UserAcco__DA6C70BA63A7E420");

            entity.ToTable("UserAccount");

            entity.HasIndex(e => e.UserEmail, "UQ__UserAcco__08638DF83527CEC8").IsUnique();
        ...
        {
            entity.HasKey(e => e.PaintingId).HasName("PK__Watercol__CF2D90F2A5B6D67A");
